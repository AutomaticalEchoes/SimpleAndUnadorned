...
@OnlyIn(Dist.CLIENT)
public class SusPillagerRender extends IllagerRenderer<SusPillager> {
    private static final ResourceLocation PILLAGER = new ResourceLocation("textures/entity/illager/pillager.png");

    public SusPillagerRender(EntityRendererProvider.Context p_174354_) {
    ...
    public ResourceLocation getTextureLocation(SusPillager p_115720_) {
        return PILLAGER;
    }
}
