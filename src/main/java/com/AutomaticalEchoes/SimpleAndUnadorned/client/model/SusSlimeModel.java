...
import com.AutomaticalEchoes.SimpleAndUnadorned.api.IRenderType;
...
public class SusSlimeModel <T extends Entity> extends HierarchicalModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION_SLIME= new ModelLayerLocation(new ResourceLocation(SimpleAndUnadorned.MODID, "sus_slime"), "inner");
    public static final ModelLayerLocation LAYER_LOCATION_SLIME_OUTER= new ModelLayerLocation(new ResourceLocation(SimpleAndUnadorned.MODID, "sus_slime"), "outer");
