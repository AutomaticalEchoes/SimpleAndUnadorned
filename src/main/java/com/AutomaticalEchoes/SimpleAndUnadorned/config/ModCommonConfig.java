...
public class ModCommonConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> SUSPICIOUS_SLIME_ACIDITY_PREPARE;
    ...
    static {
        ...
        SUSPICIOUS_SLIME_WANT_COLLECT_TICK = BUILDER.defineInRange("SUSPICIOUS_SLIME want collect cool down",4,3,5);
        SUSPICIOUS_SLIME_TRANSLATE_TICK = BUILDER.defineInRange("SUSPICIOUS_SLIME translate tick",30,15,45);
        SUSPICIOUS_SLIME_ACIDITY_PREPARE = BUILDER.defineInRange("SUSPICIOUS_SLIME_BASE prepare acidity ball",60,40,600);
        BUILDER.pop();
